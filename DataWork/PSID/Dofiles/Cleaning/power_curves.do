...
line r* theta1 , ylabel(0(0.1)1) xlabel(-3(0.5)3) ytitle("pr(reject {&beta}=0)") xtitle("{&beta}{sub:0}/||{&pi}{sub:2}|| ") ///
	lpattern("l" "_" "-" "_-") note("Mean of first-stage {it:F} statistic: {&eta}: `F2_mean'; {&beta}: `F1_mean'") scheme(sj)


//graph export "./power_2sls_strong_het.eps", replace
//graph export "./twostepweakiv3.eps", replace
graph export "./twostepweakiv4.eps", replace
